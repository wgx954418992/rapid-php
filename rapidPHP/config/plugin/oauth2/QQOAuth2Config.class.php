...
class QQOAuth2Config
{
     ...
     * @return string
     */
    public static function getCode2Url($appId, $callUrl, $state = '', $scope = '')
    {
     ...
     * @return string
     */
    public static function getAccessTokenUrl($appId, $secret, $code, $callUrl)
    {
     ...
     * @return string
     */
    public static function getOpenIdUrl($accessToken, $isUnionId = '1')
    {
     ...
     * @return string
     */
    public static function getUserInfoUrl($appId, $accessToken, $openId)
    {
