...
class Spyc
{
    ...
    // SETTINGS
    private const REMPTY = "\0\0\0\0\0";
     ...
     * @param int|bool $indent Pass in false to use the default, which is 2
     * @param int|bool $wordwrap Pass in 0 for no wordwrap, false for default (40)
    ...
    private function _yamlize($key, $value, $indent, $previous_key = -1, $first_key = 0, $source_array = null)
    {
        ...
        if (is_array($value)) {
            if (empty ($value)) return $this->_dumpNode($key, array(), $indent, $previous_key, $first_key, $source_array);
    ...
    private function loadWithSource($Source)
    {
        ...
        for ($i = 0; $i < $cnt; $i++) {
            ...
            if ($literalBlockStyle)
                $lineArray = $this->revertLiteralPlaceHolder($lineArray, isset($literalBlock) ? $literalBlock : null);
