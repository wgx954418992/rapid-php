...
class Math
{
     ...
     * @return float
     */
    public static function getDistance(float $startLongitude, float $startLatitude, float $endLongitude, float $endLatitude, int $decimal = 2)
    {
        $PI = 3.1415926;
     ...
     * @return string
     */
    public static function getDistanceString(float $startLongitude, float $startLatitude, float $endLongitude, float $endLatitude, int $decimal = 2)
    {
        $unit = 'M';
     ...
     * @return string
     */
    public static function getTextBySize($size)
    {
        $units = [' B', ' KB', ' MB', ' GB', ' TB'];
