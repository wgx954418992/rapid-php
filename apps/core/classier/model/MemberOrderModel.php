...
class MemberOrderModel extends Model 
{
    ...
    /**
     * 设置 总金额
     * @param float|null $total_fee
     */
    public function setTotalFee(?float $total_fee)
    {
     ...
     * @throws Exception
     */
    public function validTotalFee(string $msg = 'total_fee Cannot be empty!')
    {
        if (empty($this->total_fee)) throw new Exception($msg);
    }
