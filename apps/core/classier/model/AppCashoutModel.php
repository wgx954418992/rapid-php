...
class AppCashoutModel extends Model 
{

    /**
     * table name
     */
    const NAME = 'app_cashout';
     ...
     * @throws Exception
     */
    public function validAccount(string $msg = 'account Cannot be empty!')
    {
        if (empty($this->account)) throw new Exception($msg);
    }
     ...
     * @throws Exception
     */
    public function validAccountType(string $msg = 'account_type Cannot be empty!')
    {
        if (empty($this->account_type)) throw new Exception($msg);
    }
