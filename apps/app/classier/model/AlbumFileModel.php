 ...
 * 相册成员
 * @table album_file
 * rapidPHP auto generate Model 2020-12-13 00:03:15
 */
class AlbumFileModel extends Model
{
     ...
     * @throws Exception
     */
    public function validAlbumId(string $msg = 'album_id Cannot be empty!')
    {
        if(empty($this->album_id)) throw new Exception($msg);
    }
