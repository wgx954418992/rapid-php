...
<head>
    ...
    <title>Rapid - 后台管理系统</title>
    <link href="../../../res/layout/bootstrap.min.css" rel="stylesheet">
    <link href="../../../res/layout/awesome.min.css" rel="stylesheet">
...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                       <span>
                        <img src='../../../res/assets/app_logo.png' style="max-width: 60px" class="img-circle">
                        </span>
                    ...
                    <div class="logo-element">Rapid</div>
                </li>
                <?php
                ...
                foreach ($routes as $route):?>
                    ...
                    <li>
                        <a class="<?= $routeString ? 'J_menuItem' : '' ?>" href="<?= $routeString ? VT($this)->toUrl($routeString) : 'javascript:void (0)' ?>">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right">Rapid后台管理系统。</div>
        </div>
    </div>
    <!--右侧部分结束-->
    <!--右侧边栏开始-->
...
<script src="../../../libs/plugins/metisMenu/jquery.metisMenu.js"></script>
<script src="../../../libs/plugins/slimscroll/jquery.slimscroll.min.js"></script>
<script src="../../../libs/plugins/layer/layer.js"></script>
<script src="../../../libs/plugins/iCheck/icheck.min.js"></script>
<script src="../../../libs/jquery/jquery.admin.min.js"></script>
