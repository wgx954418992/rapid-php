...
<head>
    ...
    <style type="text/css">
        .background {
            background: url("../../res/assets/admin_login_background.jpg") no-repeat center;
    ...
    <div class="form animated fadeInDownBig">
        <div>
            <h1 class="logo-name" style="font-size: 100px">
                <img src='../../res/assets/app_logo.png' style="max-width: 110px;margin-bottom: 10px;border-radius: 100%">
            </h1>
        </div>
        <h3 class="title">Rapid - 后台管理系统</h3>
