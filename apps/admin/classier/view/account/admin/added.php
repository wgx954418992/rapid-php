<!DOCTYPE html>
<html lang="zh" data-controller="BaseController|account/admin/AddedController">
<head>
    <meta charset="utf-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class='col-sm-3 rapid-mg-r'>
                                ...
                                <select title="类型" name="type"
                                        class="input-sm form-control input-s-sm inline rapid-mg-t">
                                    <?php foreach (Type::getConstantsWithStatic() as $value): ?>
                                        <option value='<?= $value->getRawValue() ?>' <?= $value->getRawValue() == $adminModel->getType() ? 'selected' : '' ?>>
                                            <?= $value ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
