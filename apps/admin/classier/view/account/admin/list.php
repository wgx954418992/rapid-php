                    ...
                    <form class="row" method="get">
                        ...
                        <div class="col-sm-2">
                            <select title="类型" name="type" class="form-control input-s-sm inline">
                                ...
                                <?php foreach (Type::getConstantsWithStatic() as $type => $text) : ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($creator != null): ?>
                                        <a data-iframe
                                           ...
                                           data-toggle='tooltip'
                                           title='查看创建者信息'
                                           href='<?= VT($this)->toUrl('account/admin/added', ['id' => $creator->getId()]) ?>'>
                                            <?= $creator->getNickname() ?>
                                        </a>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <a data-iframe
                                       ...
                                       data-toggle='tooltip'
                                       title='查看创建的子账号'
                                       href='<?= VT($this)->toUrl('account/admin/list', ['admin_id' => $value->getId()]) ?>'>
                                        <?= $value->getChildCount() ?>
                                    </a>
                                </td>
                                ...
                                <td>
                                    <a data-iframe
                                       href="<?= VT($this)->toUrl('account/admin/added', ['id' => $value->getId()]) ?>"
                                       data-toggle='tooltip'
                                       title='修改管理员信息'
                                    ...
                                    <a data-iframe
                                       href="<?= VT($this)->toUrl('account/admin/{adminId}/access/added', ['adminId' => $value->getId()]) ?>"
                                       data-toggle='tooltip'
                                       title='设置管理员权限'
                                       class='btn btn-white btn-bitbucket'>
                                    ...
                                    <a data-toggle='tooltip' title='删除管理员'
                                       data-rapid
                                       data-rapid-on-click='del("admin","<?= $value->getId() ?>")'
                                       class='btn btn-white btn-bitbucket'>
