...
/** @var LogListCondition $condition */
                    ...
                    <table class="table table-striped">
                        ...
                        foreach (VT($this)->get('list') as $value) :?>
                           <tr>
                                ...
                                <td data-type='msg' style="word-break: break-all"><?=$value->getMsg()?></td>
                                <td data-type='content' style="word-break: break-all"><?=$value->getContent()?></td>
