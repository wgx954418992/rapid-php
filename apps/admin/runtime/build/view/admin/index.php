<?php /** cache Time 2021-08-08 09:24:04 */ defined('PATH_APP') or die();?>
<?php
...
<head>
    ...
    <link href="http://localhost/guangying/code/light/apps/admin/public/res/layout/bootstrap.min.css" rel="stylesheet">
    <link href="http://localhost/guangying/code/light/apps/admin/public/res/layout/awesome.min.css" rel="stylesheet">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                       <span>
                        <img src='http://localhost/guangying/code/light/apps/admin/public/res/assets/app_logo.png' style="max-width: 60px" class="img-circle">
                        </span>
...
<script src="http://localhost/guangying/code/light/apps/admin/public/libs/plugins/metisMenu/jquery.metisMenu.js"></script>
<script src="http://localhost/guangying/code/light/apps/admin/public/libs/plugins/slimscroll/jquery.slimscroll.min.js"></script>
<script src="http://localhost/guangying/code/light/apps/admin/public/libs/plugins/layer/layer.js"></script>
<script src="http://localhost/guangying/code/light/apps/admin/public/libs/plugins/iCheck/icheck.min.js"></script>
<script src="http://localhost/guangying/code/light/apps/admin/public/libs/jquery/jquery.admin.min.js"></script>
